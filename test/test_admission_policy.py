...
from openapi_client.models.admission_policy import AdmissionPolicy  # noqa: E501
from openapi_client.rest import ApiException

class TestAdmissionPolicy(unittest.TestCase):
    """AdmissionPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.admission_policy.AdmissionPolicy()  # noqa: E501
        if include_optional :
            return AdmissionPolicy(
                id = '', 
                rules = [
                    openapi_client.models.admission/rule.admission.Rule(
                        attack_techniques = [
