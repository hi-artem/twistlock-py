...
from openapi_client.models.shared_registry_specification import SharedRegistrySpecification  # noqa: E501
from openapi_client.rest import ApiException

class TestSharedRegistrySpecification(unittest.TestCase):
    """SharedRegistrySpecification unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SharedRegistrySpecification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.shared_registry_specification.SharedRegistrySpecification()  # noqa: E501
        if include_optional :
            return SharedRegistrySpecification(
                cap = 56, 
                collections = [
                    ''
                    ], 
    ...
    def testSharedRegistrySpecification(self):
        """Test SharedRegistrySpecification"""
