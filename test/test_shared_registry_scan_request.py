...
from openapi_client.models.shared_registry_scan_request import SharedRegistryScanRequest  # noqa: E501
from openapi_client.rest import ApiException

class TestSharedRegistryScanRequest(unittest.TestCase):
    """SharedRegistryScanRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SharedRegistryScanRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.shared_registry_scan_request.SharedRegistryScanRequest()  # noqa: E501
        if include_optional :
            return SharedRegistryScanRequest(
                scan_id = 56, 
                settings = openapi_client.models.shared/registry_specification.shared.RegistrySpecification(
                    cap = 56, 
                    collections = [
                        ''
                        ], 
                    ...
                    version = '', 
                    version_pattern = '', ), 
                tag = openapi_client.models.shared/image_tag.shared.ImageTag(
                    digest = '', 
                    id = '', 
                    registry = '', 
                    repo = '', 
    ...
    def testSharedRegistryScanRequest(self):
        """Test SharedRegistryScanRequest"""
